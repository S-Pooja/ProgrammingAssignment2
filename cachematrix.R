## This is a R function to cache the potentially time-consuming 
## computation of calculating the inverse of a matrix.

## The first function "makeCacheMatrix" creates a special "vector", which 
## is really a list containing a function to a) set the value of the matrix, 
## b) get the value of the matrix, c) set the value of the inverse, 
## and d) get the value of the inverse
...
## "vector" created with the above function. However, it first checks 
